...
# InfluxDBの基本情報読み込み
with open("setting/InfluxDB_key.json")as f:
    influxdb_key = json.load(f)

class InfluxDBWrapper:
    def __init__(self, db_name):
        self.name = db_name
        self.url = influxdb_key[db_name]['url']
        self.token = influxdb_key[db_name]['token']
        self.org = influxdb_key[db_name]['org']
        self.bucket = influxdb_key[db_name]['bucket']
